    ...
    while N_hits_ini < N_ones_wanted_ini: 
        ...
        if A ==0:
           ...
           # print M1_ini_1
            ...
            #print 'here', samples_ini_M1[0]
            gaus_mean_for_ref1.append([samples_ini_M1[0],samples_ini_a[0],samples_ini_q[0]])
            #print prior_M1(samples_ini_M1[-1])
            #print ' Hallo Jeroen ik ben hier'
